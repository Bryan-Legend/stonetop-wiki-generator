...
- **Whole-language pass (2026-09-24; binding list in `i18n/_work/pl-brief.md`):** GM/NPC/PC = MG/BN/BG · harm = obrażenia · Armor = Pancerz · site = miejsce · expedition = wyprawa · Homefront = Front domowy · countdown = odliczanie · Burn Brightly = Płonąć Jasno · Strengthen Your Bond = Wzmocnić Więź · Bolster = Wzmocnić Się (hold Przygotowanie) · Make a Plan = Ułożyć Plan · Order Followers = Rozkazywać Stronnikom · threat types: plaga/przypadłość (affliction) · dżoker (wildcard) · istota magiczna · złoczyńca · tłuszcza · impending doom = nadciągająca zguba · grim portents = złowrogie znaki · Highway = Gościniec · West Road = Zachodni Trakt · Crossroads = Rozstaje · Stormcatcher = Łowczyni Burz · Lady of Crows = Pani Wron · Hollow Fae = Wydrążeni Fae · aetherium = eterium · black iron = czarne żelazo · tether = kotwica · "(page N)" = "(str. N)" (`page_words` in `ui/pl.json`)
